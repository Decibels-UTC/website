...
function NavBar() {
  ...
  /*<Menu.Item
        name='massiveadd'
        active={activeItem === 'massiveadd'}
        onClick={handleItemClick}

      ><Link to="/massiveadd">Massiveadd</Link></Menu.Item>*/
  ...
  return (
    ...
    <Menu inverted style={{padding:'5px'}}>
      ...
      >
        <Link to="/portefolio">Portefolio</Link></Menu.Item>
      ...
      >
        <Link to="/anciens">Anciens</Link></Menu.Item>
      <Menu.Item
        name='matos'
      ...
      >
        <Link to="/matos">Matos</Link></Menu.Item>
